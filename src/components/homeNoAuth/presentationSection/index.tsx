    ...
    <Container className="py-4">
        <Row>
            <Col md className="d-flex flex-column justify-content-center align-items-start">
                ...
                <p className={styles.title}>Tenha acesso aos melhores cursos.</p>
                <p className={styles.description}>Estude de onde estiver, a qualquer momento, e continue evoluindo.</p>
                <Link href="/register">
                    <Button variant="outline-primary" className={styles.btnCta}>
